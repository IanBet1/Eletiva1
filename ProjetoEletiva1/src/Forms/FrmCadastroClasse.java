...
public class FrmCadastroClasse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Formulário Cadstro de Classe");
        ...
        cmbClasse.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 11)); // NOI18N
        ...
        btnFiltrar.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 11)); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ícones/associar.png"))); // NOI18N
    ...
    private void preencheCampos() {
        ...
        if (linhaSelecionada != -1) {
            ...
            cmbProfessor.addItem(c.getProfessor());
