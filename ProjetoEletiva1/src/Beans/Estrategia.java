...
@NamedQueries({
    ...
    @NamedQuery(name = "Estrategia.findEstrtegia", query = "SELECT e FROM Estrategia e WHERE e.estrategia = :estrategia AND e.areaconhecimentoIdconhecimento.idconhecimento = :areaconhecimento")})
